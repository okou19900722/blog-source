...
import io.vertx.future.core.Future;
...
public abstract class AbstractVerticle implements Verticle {
   ...
   */
  @Override
  public final void start(io.vertx.core.Future<Void> startFuture) throws Exception {
    start(Future.newInstance(startFuture));
  }
  /**
   * Start the verticle.<p>
   * This is called by Vert.x when the verticle instance is deployed. Don't call it yourself.<p>
   ...
   */
  @Override
  public final void stop(io.vertx.core.Future<Void> stopFuture) throws Exception {
    stop(Future.newInstance(stopFuture));
  }
  /**
   * Stop the verticle.<p>
   * This is called by Vert.x when the verticle instance is un-deployed. Don't call it yourself.<p>
